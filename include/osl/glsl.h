...
template<class genType> inline genType name(const genType &a) {return map_to_scalar(a,name##_scalar);}
#define SOFTWARE_GLSL_VEC_2arg(name,expression) \
inline float name##_scalar(float a,float b) {return expression;} \
template<class genType> inline genType name(const genType &a,const genType &b) {return map_to_scalar(a,b,name##_scalar);}
#define SOFTWARE_GLSL_VEC_3arg(name,expression) \
inline float name##_scalar(float a,float b,float c) {return expression;} \
template<class genType> inline genType name(const genType &a,const genType &b,const genType &c) {return map_to_scalar(a,b,c,name##_scalar);}
...
SOFTWARE_GLSL_VEC_2arg(pow,pow((float)a,(float)b));
